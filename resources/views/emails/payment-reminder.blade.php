...
<head>
    ...
    <style>
        ...
        .due-box {
            ...
            background: #FFF8E1; border: 1px solid #FFECB3; margin: 24px 0;
        }
        .due-box h4 { font-family: 'Playfair Display', serif; font-size: 15px; color: #F57F17; margin: 0 0 10px; }
        .due-box p { font-size: 13px; color: #8D6E04; line-height: 1.8; margin: 0; }
        .btn {
            display: inline-block; padding: 14px 32px; border-radius: 9999px;
            background: linear-gradient(135deg, #1A3B32, #2c5b4c); color: #fff;
            text-decoration: none; font-size: 14px; font-weight: 600;
            margin-top: 8px;
        }
        .footer {
            text-align: center; padding: 32px 40px;
            background: #1A1A1A; color: rgba(255,255,255,0.4); font-size: 12px;
        }
...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            <p style="font-size:14px;color:#666;line-height:1.8;">Hi {{ $booking->customer_name }}, this is a friendly reminder about the outstanding balance for your upcoming booking.</p>
            ...
            <div class="detail-block">
                ...
                <div class="row"><span class="label">Remaining Balance</span><span class="value" style="color:#F57F17;">₱{{ number_format($booking->total_amount - $booking->amount_paid, 2) }}</span></div>
            </div>

            <div class="due-box">
                <h4>Please settle your balance before your booking date</h4>
            ...
            <div style="text-align:center;margin-top:24px;">
                <a class="btn" href="{{ url('/') }}">View Our Packages</a>
            </div>

            <p style="font-size:12px;color:#999;text-align:center;margin-top:28px;">Need to reschedule? Please reach out 1-2 days before your slot.</p>
        </div>
