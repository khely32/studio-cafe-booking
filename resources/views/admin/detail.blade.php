...
<div style="display:grid;grid-template-columns:2fr 1fr;gap:24px;">
    <div>
        <div class="card" style="margin-bottom:24px;">
            <div class="card-header"><h2>Booking Information</h2></div>
            <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div style="margin-top:16px;padding:12px;background:var(--gray-50);border-radius:var(--radius-sm);border:1px solid var(--gray-200);">
    ...
    <div>
        <div class="card" style="margin-bottom:24px;">
            ...
            <div class="card-body" style="text-align:center;">
                <span class="page-card-badge badge-{{ $booking->status_badge }}" style="font-size:13px;padding:6px 20px;">{{ ucfirst($booking->status) }}</span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div style="display:flex;justify-content:space-between;margin-bottom:12px;">
                    ...
                    <span style="font-weight:700;font-size:18px;">₱{{ number_format($booking->total_amount, 2) }}</span>
                </div>
                <div style="display:flex;justify-content:space-between;margin-bottom:12px;">
                ...
                <div style="display:flex;justify-content:space-between;">
                    ...
                    <span class="page-card-badge badge-{{ $booking->payment_status==='paid'?'active':'pending' }}">{{ ucfirst($booking->payment_status) }}</span>
                </div>
            </div>
        </div>
    </div>
